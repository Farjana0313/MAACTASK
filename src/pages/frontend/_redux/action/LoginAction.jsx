...
export const SignInData = (postData) => async (dispatch) => {
  if (postData.employeeId.length === 0) {
...
//           showToast("success", res.data.message);
//           if (postData.remember === true) {
//             localStorage.setItem("is_ps_remember_me", true);
//           }
//           // Store data's to local storage
//           localStorage.setItem("is_ps_logged_in", true);
